...
A minimal Sentinel-2 shoreline measurement app. It includes monthly and twice-monthly views from August 2015 onward, using the best qualifying scenes with zero cloud, shadow, cirrus, or snow/ice Scene Classification Layer pixels over the North Wildwood oceanfront and no more than 0.5% invalid pixels. A separate view includes every qualifying cloud-free acquisition captured within 1 hour 45 minutes before or after NOAA-predicted low tide.
